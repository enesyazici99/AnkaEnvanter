...
<center>
            ...
            <div class="card-body">
                ...
                <hr>
                <h4 class="card-title">Kullanıcı Email : {{ $adminData->email }} </h4>
                <hr>
                <h4 class="card-title">Kullanıcı Adı : {{ $adminData->username }} </h4>
                <hr>
                <a href="{{ route('edit.profile') }}" class="btn btn-info btn-rounded waves-effect waves-light" > Profili Düzenle</a>
