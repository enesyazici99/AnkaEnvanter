...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Profil Sayfasını Düzenle </h4>
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">KullanıcıAdı</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Profil Fotoğrafı </label>
                <div class="col-sm-10">
