...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Günlük Fatura Raporu </h4><br><br>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="md-3 form-group">
                <label for="example-text-input" class="form-label">Başlangıç Tarihi</label>
        ...
        <div class="col-md-4">
            <div class="md-3 form-group">
                <label for="example-text-input" class="form-label">Bitiş Tarihi</label>
...
<script type="text/javascript">
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                start_date: {
                    required : 'Lütfen Başlangıç Tarihini Seçiniz',
                },
                end_date: {
