...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('product.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> Ürün Ekle </i></a> <br>  <br>               

                    <h4 class="card-title">Tüm Ürün Verileri </h4>
