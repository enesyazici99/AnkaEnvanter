                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Müşteri Bazlı Kredili Rapor</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li>
                                            <li class="breadcrumb-item active">Müşteri Bazlı Kredili Rapor</li>
                                        </ol>
                                    </div>
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-center"><strong>Müşteri İsmi </strong></td>
            <td class="text-center"><strong>Fatura No  </strong>
            </td>
            <td class="text-center"><strong>Tarih</strong>
            </td>
            
            <td class="text-center"><strong>Ödenecek Miktar  </strong>
            </td>
        ...
        @endforeach
            ...
            <tr>
                ...
                <td class="no-line text-center">
                    <strong>Toplam Ödenecek Miktar</strong></td>
