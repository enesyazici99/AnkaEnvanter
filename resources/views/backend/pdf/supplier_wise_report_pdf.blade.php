                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Tedarikçi Bazlı Stok Raporu</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li>
                                            <li class="breadcrumb-item active">Tedarikçi Bazlı Stok Raporu</li>
                                        </ol>
                                    </div>
...
<div class="table-responsive">
    ...
    <h3 class="text-center"><strong>Tedarikçi İsmi : </strong> {{ $allData['0']['supplier']['name'] }} </h3>
