...
@section('admin')
 ...
 <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex  align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Tüm Kredili Müşteriler</h4>
    ...
    <a href="{{ route('credit.customer.print.pdf') }}" target="_blank" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fa fa-print"> Kredili Müşterileri Yazdır  </i></a> <br>  <br>               

                    <h4 class="card-title">Kredili Müşteri Verileri </h4>
