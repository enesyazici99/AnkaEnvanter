...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Birim İsmi </label>
...
<input type="submit" class="btn btn-info waves-effect waves-light" value="Birimi Güncelle">
            </form>
