...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('unit.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> Birim Ekle </i></a> <br>  <br>               

                    <h4 class="card-title">Tüm Birim Verileri </h4>
