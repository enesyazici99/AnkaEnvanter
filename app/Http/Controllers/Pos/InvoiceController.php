...
class InvoiceController extends Controller
{
    ...
    if ($request->category_id == null) {
       ...
       $notification = array(
        'message' => 'Üzgünüz Herhangi Bir Öğe Seçmediniz', 
        'alert-type' => 'error'
    );
    return redirect()->back()->with($notification);
        ...
        if ($request->paid_amount > $request->estimated_amount) {
           ...
           $notification = array(
        'message' => 'Üzgünüz Ödenen Tutar En Fazla Topam Fiyat Olabilir', 
        'alert-type' => 'error'
    );
    return redirect()->back()->with($notification);
    ...
    DB::transaction(function() use($request,$invoice){
     ...
     $notification = array(
        'message' => 'Fatura Verisi Ekleme Başarılı', 
        'alert-type' => 'success'
    );
    ...
    public function ApprovalStore(Request $request, $id){
        ...
        $notification = array(
        'message' => 'Üzgünüz Stok Değerinin Üstünde Bir Miktarı Onaylıyorsunuz', 
        'alert-type' => 'error'
    );
    return redirect()->back()->with($notification); 
    ...
    $notification = array(
        'message' => 'Fatura Onaylama Başarılı', 
        'alert-type' => 'success'
    );
    return redirect()->route('invoice.pending.list')->with($notification);  
