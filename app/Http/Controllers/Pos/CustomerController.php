...
class CustomerController extends Controller
{
    ...
    public function CustomerUpdate(Request $request){
        ...
        Customer::findOrFail($customer_id)->update([
         ...
         $notification = array(
            'message' => 'Resimli Müşteri Güncellemesi Başarılı', 
            'alert-type' => 'success'
        );
        ...
        return redirect()->route('customer.all')->with($notification);
         ...
         $notification = array(
            'message' => 'Resimsiz Müşteri Güncellemesi Başarılı', 
            'alert-type' => 'success'
        );
    ...
    public function CustomerUpdateInvoice(Request $request,$invoice_id){
        ...
        if ($request->new_paid_amount < $request->paid_amount) {
            ...
            $notification = array(
            'message' => 'Üzgünüz, Maksimum Değeri Ödediniz', 
            'alert-type' => 'error'
        );
        return redirect()->back()->with($notification); 
        } else{
            ...
            $payment_details->save();
              ...
              $notification = array(
            'message' => 'Fatura Güncelleme Başarılı', 
            'alert-type' => 'success'
        );
